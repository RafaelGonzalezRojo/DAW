 ...
 * 
 * @author Rafael Gonzalez Rojo
 */

public class C07biEjercicio7 {
    ...
    do {
      ...
      int distanciay = 0;
       ...
       System.out.println("minax: " + minaX + "minay:" + minaY ); 
           ...
           distanciax = minaX - x;
          System.out.println("su distancia de x es:" + distanciax); 
             
      distanciay = minaY - y;
          System.out.println("su distancia de y es:" + distanciay); 
         
     distanciax = Math.abs(distanciax);
      
          System.out.println("su distancia de x abs es:" + distanciax); 
          
      distanciay = Math.abs(distanciay);
      
          System.out.println("su distancia de y abs es:" + distanciay);    
